...
def config():      
  ...
  s('echo "Configuring Firewall for rsyslog monitoring"; firewall-cmd --zone=public --add-port=514/tcp --permanent; firewall-cmd --zone=public --add-port=514/udp --permanent; firewall-cmd --reload; systemctl restart monit rsyslog')
